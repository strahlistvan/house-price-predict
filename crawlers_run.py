...
crawler_url = 'http://ingatlan.com/szukites/elado+lakas+baja' #'http://ingatlan.com/lista/elado+lakas' # 'http://ingatlan.com/szukites/elado+lakas+baja'
db_url = 'mongodb://localhost:27017'
db_name = 'house_price_predict'
date_format_str = '%d/%m/%Y %H:%M:%S.%f'
page_limit = 100 # feel free to change
...
#dao = MongoDAO(conn_url=db_url, dbname=db_name)
#all_doc = list()
#for collname in dao.get_all_collection_names():
#        all_doc.append(collname)
        #all_doc[collname.replace('.', '')]= dao.get_all_documents(collname)

#print(type(all_doc))
#dao.collname = 'house_prices_test_baja_2'
#dao.db[dao.collname].insert_many(all_doc)